...
urlpatterns = [
    ...
    path('confrim/<uidb64>/<token>/',views.UserPasswordResetConfrimView.as_view(), name='password_reset_confrim'),
    path('confrim/complate/',views.UserPasswordResetCompleteView.as_view(), name='password_reset_complate'),
